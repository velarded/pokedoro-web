...
export default function LoginPage() {
  ...
  return (
    <div className={vt323.className}>
        ...
        <div className="relative z-10 flex items-center justify-center px-4" style={{ marginTop: '8vh' }}>
            ...
            <div className="bg-white bg-opacity-95 rounded-3xl shadow-2xl p-8 backdrop-blur-sm" style={{
                ...
                <input
                    ...
                    className="w-full px-4 py-3 bg-pink-50 border border-pink-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-transparent text-gray-700 placeholder-gray-400"
                />
                </div>
